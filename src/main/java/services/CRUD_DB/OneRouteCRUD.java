...
return busParkList;
    ...
    public void updateRoute (int id , Route_Entity routeEntity){
        String sql = "UPDATE ROUTE SET ROUTE=?,FULL_ROUTE=?,avarage_Profit=?,avarage_Fuel_Consuption=?";
        try{
    ...
    public void deleteRoute(int id){
        String sql = "UPDATE ROUTE SET ROUTE=null,FULL_ROUTE=null,avarage_Profit=null,avarage_Fuel_Consuption=null";
        try {
            PreparedStatement preparedStatement =connection.prepareStatement(sql);
            preparedStatement.execute();
